...
import {DetectStackDriftCommandInput} from '@aws-sdk/client-cloudformation';
...
exports.handler = async (event: APIGatewayEvent) => {
  ...
  try {
    ...
    const q: DetectStackDriftCommandInput = {
      StackName: stackName,
    };
    ...
    const s = await client.detectStackDrift(region, q);
